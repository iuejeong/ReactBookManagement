...
const BookRegister = () => {
    ...
    const searchSubmitHandle = (e) => {
        ...
        setSearchParams({...searchParams, page: 1});     // 검색하면 페이지 번호를 1로 바꿈
        setRefresh(true);
    }
    ...
    const checkBookHandle = (e) => {
        ...
        console.log(getBooks.data.data.bookList)
        // filter는 filter 안의 조건이 참이면 참인 것들만 새로운 배열에 담는다. 거기에 [0]면 배열의 첫 번째 값이기에 새로운 값을 의미 함.
